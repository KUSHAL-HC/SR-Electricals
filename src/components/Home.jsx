    ...
    <div className="bg-warning-subtle">
      ...
      <div className="position-relative text-center text-white">
        <img 
          ...
          className="w-100" 
          alt="hero"
          style={{ filter: "brightness(50%)", maxHeight: "600px", objectFit: "cover" }}
        />

        <div className="position-absolute top-50 start-50 translate-middle">
          <div className="border-start border-5 border-warning ps-3">
            <h1 className="display-4">Spares & Services</h1>
